...
final class LocalizationTests: XCTestCase {
    ...
    private func everySentence(_ language: Language) -> [(String, String)] {
        ...
        for pair in [("health.healthTitle", health.healthTitle),
                     ...
                     ("health.finderLabel", health.finderLabel),
                     ("health.finderStoppedFix", health.finderStoppedFix),
                     ...
                     ("health.memoryLabel", health.memoryLabel), ("health.megabytes", health.megabytes(48))] { add(pair.0, pair.1) }
