...
<p align="center">
  ...
  <img alt="Unit tests" src="https://img.shields.io/badge/tests-368%20passing-2ea44f">
</p>
...
- `swift test` runs 368 tests across the two library targets (330 + 38); the app target's verification is
